...
const (
	RateLimiter_Check_FullMethodName = "/agora.ratelimit.v1.RateLimiter/Check"
)
...
var RateLimiter_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "agora.ratelimit.v1.RateLimiter",
